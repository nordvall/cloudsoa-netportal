...
using CloudSOA.NetPortal.Tokens;
using RestSharp;
using System.Net;

namespace CloudSOA.NetPortal.Web.Controllers
{
    [Authorize]
    public class DjangoController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            var items = SendRequest<List<ToDoItemViewModel>>(request, HttpStatusCode.OK);
        ...
        public ActionResult Edit(int id = 0)
        {
            ...
            if (id > 0)
            {
                ...
                item = SendRequest<ToDoItemViewModel>(request, HttpStatusCode.OK);
            }
        ...
        [HttpPost]
        public ActionResult Edit(ToDoItemViewModel item)
        {
            ...
            if (item.id > 0)
            {
                ...
                SendRequest<ToDoItemViewModel>(request, HttpStatusCode.OK);
            }
            else
            {
                var request = new RestRequest("", Method.POST);
                request.AddJsonBody(item);
                SendRequest<ToDoItemViewModel>(request, HttpStatusCode.Created);
            }
